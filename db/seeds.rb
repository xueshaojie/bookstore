...
Product.create!(title: "黑客与画家",
  ...
  image: open("http://ws2.sinaimg.cn/large/006tNc79gy1fga9zxbsysj308h0cdaak.jpg")
)
...
Product.create!(title: "智能时代",
  ...
  image: open("http://ws1.sinaimg.cn/large/006tNc79gy1fgaa5o86saj30go0nzgq6.jpg")
)
Product.create!(title: "思考,快与慢",
  ...
  image: open("http://ws1.sinaimg.cn/large/006tNc79gy1fgaadvudrbj30ii0m1aaa.jpg")
)
Product.create!(title: "必然",
  ...
  image: open("http://ws2.sinaimg.cn/large/006tNc79gy1fgaahwoa1ej31bq1z4qog.jpg")
)
Product.create!(title: "巴菲特的投资组合",
  ...
  image: open("http://ws3.sinaimg.cn/large/006tNc79gy1fgaatpb0zvj30b40go3zg.jpg")
)
